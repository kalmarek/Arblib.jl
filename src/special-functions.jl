...
function SpecialFunctions.airyai(z::ArbOrRef)
    ...
    ccall(
        ...
        Cvoid,
        (Ref{arb_struct}, Ref{Cvoid}, Ref{Cvoid}, Ref{Cvoid}, Ref{arb_struct}, Int),
        ai,
        C_NULL,
        C_NULL,
        C_NULL,
...
function SpecialFunctions.airyai(z::AcbOrRef)
    ...
    ccall(
        ...
        Cvoid,
        (Ref{acb_struct}, Ref{Cvoid}, Ref{Cvoid}, Ref{Cvoid}, Ref{acb_struct}, Int),
        ai,
        C_NULL,
        C_NULL,
        C_NULL,
...
function SpecialFunctions.airyaiprime(z::ArbOrRef)
    ...
    ccall(
        @libflint(arb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{arb_struct}, Ref{Cvoid}, Ref{Cvoid}, Ref{arb_struct}, Int),
        C_NULL,
        ai_prime,
        C_NULL,
        C_NULL,
...
function SpecialFunctions.airyaiprime(z::AcbOrRef)
    ...
    ccall(
        @libflint(acb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{acb_struct}, Ref{Cvoid}, Ref{Cvoid}, Ref{acb_struct}, Int),
        C_NULL,
        ai_prime,
        C_NULL,
        C_NULL,
...
function SpecialFunctions.airybi(z::ArbOrRef)
    ...
    ccall(
        @libflint(arb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{Cvoid}, Ref{arb_struct}, Ref{Cvoid}, Ref{arb_struct}, Int),
        C_NULL,
        C_NULL,
        bi,
        C_NULL,
...
function SpecialFunctions.airybi(z::AcbOrRef)
    ...
    ccall(
        @libflint(acb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{Cvoid}, Ref{acb_struct}, Ref{Cvoid}, Ref{acb_struct}, Int),
        C_NULL,
        C_NULL,
        bi,
        C_NULL,
...
function SpecialFunctions.airybiprime(z::ArbOrRef)
    ...
    ccall(
        @libflint(arb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{Cvoid}, Ref{Cvoid}, Ref{arb_struct}, Ref{arb_struct}, Int),
        C_NULL,
        C_NULL,
        C_NULL,
        bi_prime,
...
function SpecialFunctions.airybiprime(z::AcbOrRef)
    ...
    ccall(
        @libflint(acb_hypgeom_airy),
        Cvoid,
        (Ref{Cvoid}, Ref{Cvoid}, Ref{Cvoid}, Ref{acb_struct}, Ref{acb_struct}, Int),
        C_NULL,
        C_NULL,
        C_NULL,
        bi_prime,
