...
arbcall"void acb_poly_scalar_mul_si(acb_poly_t C, const acb_poly_t A, slong c, slong prec)"
...
arbcall"void _acb_poly_mulmid_transpose(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void acb_poly_mulmid_transpose(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec)"
arbcall"void _acb_poly_mulmid_classical(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void acb_poly_mulmid_classical(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec)"
arbcall"void _acb_poly_mulmid(acb_ptr z, acb_srcptr x, slong xlen, acb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void acb_poly_mulmid(acb_poly_t res, const acb_poly_t poly1, const acb_poly_t poly2, slong nlo, slong nhi, slong prec)"
...
arbcall"void _acb_poly_asin_series(acb_ptr res, acb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void acb_poly_asin_series(acb_poly_t res, const acb_poly_t f, slong n, slong prec)"
arbcall"void _acb_poly_acos_series(acb_ptr res, acb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void acb_poly_acos_series(acb_poly_t res, const acb_poly_t f, slong n, slong prec)"
arbcall"void _acb_poly_atanh_series(acb_ptr res, acb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void acb_poly_atanh_series(acb_poly_t res, const acb_poly_t f, slong n, slong prec)"
arbcall"void _acb_poly_asinh_series(acb_ptr res, acb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void acb_poly_asinh_series(acb_poly_t res, const acb_poly_t f, slong n, slong prec)"
arbcall"void _acb_poly_acosh_series(acb_ptr res, acb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void acb_poly_acosh_series(acb_poly_t res, const acb_poly_t f, slong n, slong prec)"
...
arbcall"void _acb_poly_cot_series(acb_ptr g, acb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void acb_poly_cot_series(acb_poly_t g, const acb_poly_t h, slong n, slong prec)"
...
arbcall"void _acb_poly_tan_pi_series(acb_ptr g, acb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void acb_poly_tan_pi_series(acb_poly_t g, const acb_poly_t h, slong n, slong prec)"
...
arbcall"void _acb_poly_tanh_series(acb_ptr g, acb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void acb_poly_tanh_series(acb_poly_t g, const acb_poly_t h, slong n, slong prec)"
arbcall"void _acb_poly_coth_series(acb_ptr g, acb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void acb_poly_coth_series(acb_poly_t g, const acb_poly_t h, slong n, slong prec)"
...
arbcall"double _acb_poly_find_roots_double(acb_ptr roots, acb_srcptr poly, acb_srcptr initial, slong len, slong maxiter, slong prec)"
arbcall"double cd_poly_find_roots(double * roots, const double * poly, const double * initial, slong len, slong maxiter, double reltol)"
arbcall"double cd_poly_refine_roots(double * z, const double * poly, slong len, double stepsize_bound)"
arbcall"double cd_poly_refine_roots_with_pivot(double * z, const double * poly, slong len, double stepsize_bound)"
