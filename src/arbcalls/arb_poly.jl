...
arbcall"void arb_poly_scalar_mul_si(arb_poly_t C, const arb_poly_t A, slong c, slong prec)"
...
arbcall"void _arb_poly_mulmid_block(arb_ptr z, arb_srcptr x, slong xlen, arb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void arb_poly_mulmid_block(arb_poly_t res, const arb_poly_t poly1, const arb_poly_t poly2, slong nlo, slong nhi, slong prec)"
arbcall"void _arb_poly_mulmid_classical(arb_ptr z, arb_srcptr x, slong xlen, arb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void arb_poly_mulmid_classical(arb_poly_t res, const arb_poly_t poly1, const arb_poly_t poly2, slong nlo, slong nhi, slong prec)"
arbcall"void _arb_poly_mulmid(arb_ptr z, arb_srcptr x, slong xlen, arb_srcptr y, slong ylen, slong nlo, slong nhi, slong prec)"
arbcall"void arb_poly_mulmid(arb_poly_t res, const arb_poly_t poly1, const arb_poly_t poly2, slong nlo, slong nhi, slong prec)"
...
arbcall"void _arb_poly_atanh_series(arb_ptr res, arb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void arb_poly_atanh_series(arb_poly_t res, const arb_poly_t f, slong n, slong prec)"
arbcall"void _arb_poly_asinh_series(arb_ptr res, arb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void arb_poly_asinh_series(arb_poly_t res, const arb_poly_t f, slong n, slong prec)"
arbcall"void _arb_poly_acosh_series(arb_ptr res, arb_srcptr f, slong flen, slong n, slong prec)"
arbcall"void arb_poly_acosh_series(arb_poly_t res, const arb_poly_t f, slong n, slong prec)"
...
arbcall"void _arb_poly_cot_series(arb_ptr g, arb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void arb_poly_cot_series(arb_poly_t g, const arb_poly_t h, slong n, slong prec)"
...
arbcall"void _arb_poly_tan_pi_series(arb_ptr g, arb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void arb_poly_tan_pi_series(arb_poly_t g, const arb_poly_t h, slong n, slong prec)"
...
arbcall"void _arb_poly_tanh_series(arb_ptr g, arb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void arb_poly_tanh_series(arb_poly_t g, const arb_poly_t h, slong n, slong prec)"
arbcall"void _arb_poly_coth_series(arb_ptr g, arb_srcptr h, slong hlen, slong n, slong prec)"
arbcall"void arb_poly_coth_series(arb_poly_t g, const arb_poly_t h, slong n, slong prec)"
