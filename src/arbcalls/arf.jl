...
# arbcall"void arf_set_fmpz(arf_t res, const fmpz_t x)"
...
# arbcall"void arf_set_fmpr(arf_t res, const fmpr_t x)"
...
# arbcall"int arf_set_round_fmpz(arf_t res, const fmpz_t x, slong prec, arf_rnd_t rnd)"
arbcall"void arf_set_si_2exp_si(arf_t res, slong m, slong e)"
arbcall"void arf_set_ui_2exp_si(arf_t res, ulong m, slong e)"
# arbcall"void arf_set_fmpz_2exp(arf_t res, const fmpz_t m, const fmpz_t e)"
# arbcall"int arf_set_round_fmpz_2exp(arf_t res, const fmpz_t x, const fmpz_t e, slong prec, arf_rnd_t rnd)"
# arbcall"void arf_get_fmpz_2exp(fmpz_t m, fmpz_t e, const arf_t x)"
# arbcall"void arf_frexp(arf_t m, fmpz_t e, const arf_t x)"
arbcall"double arf_get_d(const arf_t x, arf_rnd_t rnd)"
# arbcall"void arf_get_fmpr(fmpr_t res, const arf_t x)"
arbcall"int arf_get_mpfr(mpfr_t res, const arf_t x, mpfr_rnd_t rnd)"
# arbcall"int arf_get_fmpz(fmpz_t res, const arf_t x, arf_rnd_t rnd)"
#arbcall"slong arf_get_si(const arf_t x, arf_rnd_t rnd)"
# arbcall"int arf_get_fmpz_fixed_fmpz(fmpz_t res, const arf_t x, const fmpz_t e)"
# arbcall"int arf_get_fmpz_fixed_si(fmpz_t res, const arf_t x, slong e)"
...
# arbcall"void arf_abs_bound_lt_2exp_fmpz(fmpz_t res, const arf_t x)"
# arbcall"void arf_abs_bound_le_2exp_fmpz(fmpz_t res, const arf_t x)"
...
# arbcall"void arf_randtest(arf_t res, flint_rand_t state, slong bits, slong mag_bits)"
# arbcall"void arf_randtest_not_zero(arf_t res, flint_rand_t state, slong bits, slong mag_bits)"
# arbcall"void arf_randtest_special(arf_t res, flint_rand_t state, slong bits, slong mag_bits)"

### Input and output
arbcall"void arf_debug(const arf_t x)"
#arbcall"void arf_print(const arf_t x)"
arbcall"void arf_printd(const arf_t x, slong d)"
# arbcall"void arf_fprint(FILE * file, const arf_t x)"
# arbcall"void arf_fprintd(FILE * file, const arf_t y, slong d)"
arbcall"char * arf_dump_str(const arf_t x)"
arbcall"int arf_load_str(arf_t x, const char * str)"
# arbcall"int arf_dump_file(FILE * stream, const arf_t x)"
# arbcall"int arf_load_file(arf_t x, FILE * stream)"
...
# arbcall"int arf_add_fmpz(arf_t res, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
# arbcall"int arf_add_fmpz_2exp(arf_t res, const arf_t x, const fmpz_t y, const fmpz_t e, slong prec, arf_rnd_t rnd)"
...
# arbcall"int arf_sub_fmpz(arf_t res, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
arbcall"void arf_mul_2exp_si(arf_t res, const arf_t x, slong e)"
# arbcall"void arf_mul_2exp_fmpz(arf_t res, const arf_t x, const fmpz_t e)"
...
# arbcall"int arf_mul_fmpz(arf_t res, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
...
# arbcall"int arf_addmul_fmpz(arf_t z, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
...
# arbcall"int arf_submul_fmpz(arf_t z, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
arbcall"int arf_sosq(arf_t res, const arf_t x, const arf_t y, slong prec, arf_rnd_t rnd)"

### Summation
# arbcall"int arf_sum(arf_t res, arf_srcptr terms, slong len, slong prec, arf_rnd_t rnd)"
...
# arbcall"int arf_div_fmpz(arf_t res, const arf_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
# arbcall"int arf_fmpz_div(arf_t res, const fmpz_t x, const arf_t y, slong prec, arf_rnd_t rnd)"
# arbcall"int arf_fmpz_div_fmpz(arf_t res, const fmpz_t x, const fmpz_t y, slong prec, arf_rnd_t rnd)"
...
# arbcall"int arf_sqrt_fmpz(arf_t res, const fmpz_t x, slong prec, arf_rnd_t rnd)"
...
### Low-level methods
# arbcall"int _arf_get_integer_mpn(mp_ptr y, mp_srcptr xp, mp_size_t xn, slong exp)"
# arbcall"int _arf_set_mpn_fixed(arf_t z, mp_srcptr xp, mp_size_t xn, mp_size_t fixn, int negative, slong prec, arf_rnd_t rnd)"
arbcall"int _arf_set_round_ui(arf_t z, ulong x, int sgnbit, slong prec, arf_rnd_t rnd)"
# arbcall"int _arf_set_round_uiui(arf_t z, slong * fix, mp_limb_t hi, mp_limb_t lo, int sgnbit, slong prec, arf_rnd_t rnd)"
# arbcall"int _arf_set_round_mpn(arf_t z, slong * exp_shift, mp_srcptr x, mp_size_t xn, int sgnbit, slong prec, arf_rnd_t rnd)"
