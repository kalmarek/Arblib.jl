...
#ns arbcall"void arb_randtest_positive(arb_t x, flint_rand_t state, slong prec, slong mag_bits)"
...
#ni arbcall"int arb_get_simplest_fmpq(fmpq_t res, const arb_t x)"
...
arbcall"void arb_const_reciprocal_fibonacci(arb_t z, slong prec)"
...
arbcall"void arb_rising2_ui(arb_t u, arb_t v, const arb_t x, ulong n, slong prec)"
...
#ni arbcall"void _arb_atan_taylor_naive(nn_ptr y, ulong * error, nn_srcptr x, slong xn, ulong N, int alternating)"
#ni arbcall"void _arb_atan_taylor_rs(nn_ptr y, ulong * error, nn_srcptr x, slong xn, ulong N, int alternating)"
#ni arbcall"void _arb_exp_taylor_naive(nn_ptr y, ulong * error, nn_srcptr x, slong xn, ulong N)"
#ni arbcall"void _arb_exp_taylor_rs(nn_ptr y, ulong * error, nn_srcptr x, slong xn, ulong N)"
#ni arbcall"void _arb_sin_cos_taylor_naive(nn_ptr ysin, nn_ptr ycos, ulong * error, nn_srcptr x, slong xn, ulong N)"
#ni arbcall"void _arb_sin_cos_taylor_rs(nn_ptr ysin, nn_ptr ycos, ulong * error, nn_srcptr x, slong xn, ulong N, int sinonly, int alternating)"
#ni arbcall"int _arb_get_mpn_fixed_mod_log2(nn_ptr w, fmpz_t q, ulong * error, const arf_t x, slong wn)"
#ni arbcall"int _arb_get_mpn_fixed_mod_pi4(nn_ptr w, fmpz_t q, int * octant, ulong * error, const arf_t x, slong wn)"
...
arbcall"int _arb_vec_equal(arb_srcptr vec1, arb_srcptr vec2, slong len)"
#mo arbcall"int _arb_vec_overlaps(arb_srcptr vec1, arb_srcptr vec2, slong len)" # clashes with _arb_poly_overlaps
arbcall"int _arb_vec_contains(arb_srcptr vec1, arb_srcptr vec2, slong len)"
...
arbcall"void _arb_vec_scalar_mul_arf(arb_ptr res, arb_srcptr vec, slong len, const arf_t c, slong prec)"
arbcall"void _arb_vec_scalar_mul_ui(arb_ptr res, arb_srcptr vec, slong len, ulong c, slong prec)"
arbcall"void _arb_vec_scalar_mul_si(arb_ptr res, arb_srcptr vec, slong len, slong c, slong prec)"
...
arbcall"void _arb_vec_printn(arb_srcptr vec, slong len, slong digits, ulong flags)"
arbcall"void _arb_vec_printd(arb_srcptr vec, slong len, slong ndigits)"
