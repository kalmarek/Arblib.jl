...
products = [LibraryProduct(prefix, ["libarb"], :libarb)]
...
download_info = Dict(
    MacOS(:x86_64) => (
        "$bin_prefix/libarb.v0.0.0-6c3738555d00b8b8b24a1f5e0065ef787432513c.x86_64-apple-darwin14.tar.gz",
        "ff7997dbb5d7161a5fe498e2e21fc6647b7535d70d553986fa769d89e9767544",
    ),
    Linux(:x86_64, libc = :glibc) => (
        "$bin_prefix/libarb.v0.0.0-6c3738555d00b8b8b24a1f5e0065ef787432513c.x86_64-linux-gnu.tar.gz",
        "df511674d095990db432223183a351705b754a5c6b8e2c120e022b13dfece531",
    ),
    Windows(:x86_64) => (
        "$bin_prefix/libarb.v0.0.0-6c3738555d00b8b8b24a1f5e0065ef787432513c.x86_64-w64-mingw32.tar.gz",
        "5af9f15b30ae46c4315c5b90a8cff2f26bdb84cc6883141fb213de9488999b32",
    ),
)
